      ...
      <div className="flex flex-col max-w-lg gap-2 text-sm">
        {isEdit ? (
          ...
          <img
            src={userData.image}
            alt=""
            className="w-48 h-48 object-cover flex items-center rounded-full"
          />
        )}
        {isEdit ? (
          <input
        ...
        <div className="mt-10">
          {isEdit ? (
            <button
              className="border flex items-center justify-center border-[var(--primary)] px-8 py-2 rounded-full hover:bg-[var(--primary)] hover:text-white transition-all"
              onClick={updateUserProfile}
            >
              Save information {loading && <Loading />}
            </button>
          ) : (
            <button
